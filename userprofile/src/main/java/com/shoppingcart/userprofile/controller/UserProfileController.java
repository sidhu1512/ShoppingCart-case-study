...
public class UserProfileController {
	...
	public ResponseEntity<?>addNewCustomerProfile(@RequestBody UserProfileDTO userprofile)
	{
		try
		{
			userprofileservice.addNewCustomerProfile(new UserProfileDTO(userprofile.getFullName(),userprofile.getUsername(),userprofile.getImage(),userprofile.getEmailId(), userprofile.getMobileNumber()));
